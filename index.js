...
neeImage.setAttribute("src",randomDice2);
  ...
  if(randomNumber1>randomNumber2){
    ...
    document.querySelectorAll(".Pic")[0].setAttribute("src","images/namWon.png");

  }
  else if (randomNumber1<randomNumber2) {
      document.querySelector("h1").innerHTML="😎 Every chuha ka jaani has its day😁";
        document.querySelectorAll(".Pic")[0].setAttribute("src","images/namLose.png");
  }
  else{
    document.querySelector("h1").innerHTML="😏chal chal phir se phek, is baar dikha denge";
      document.querySelectorAll(".Pic")[0].setAttribute("src","images/angryNam.png");
  }
